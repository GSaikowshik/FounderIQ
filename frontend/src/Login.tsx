        ...
        <div className="glass-card rounded-2xl p-1 relative shadow-[0_8px_60px_rgba(6,182,212,0.15)]">
          ...
          <div className="relative bg-slate-900/60 rounded-xl p-8 backdrop-blur-2xl">
            {isSignupSuccess ? (
              ...
              >
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 mb-6 shadow-[0_0_20px_rgba(16,185,129,0.2)]">
                ...
                <p className="text-slate-300 text-sm leading-relaxed mb-8">
                  ...
                  <button
                    ...
                    className="text-cyan-400 hover:text-cyan-300 font-semibold underline decoration-cyan-400/30 hover:decoration-cyan-300 transition-all outline-none cursor-pointer"
                  >
                    sign in
                  </button>{' '}
                  to continue.
                ...
                <motion.button
                  ...
                  className="w-full py-3.5 rounded-xl font-bold text-white bg-gradient-to-r from-cyan-600 to-indigo-600 hover:from-cyan-500 hover:to-indigo-500 shadow-[0_0_20px_rgba(6,182,212,0.3)] hover:shadow-[0_0_30px_rgba(6,182,212,0.5)] transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer"
                >
                ...
                <div className="flex rounded-xl bg-slate-800/60 p-1 mb-6 gap-1">
                  {(['signin', 'signup'] as AuthMode[]).map((m) => (
                    <button
                      key={m}
                      type="button"
                      onClick={() => { setMode(m); setMessage(null); setIsSignupSuccess(false); }}
